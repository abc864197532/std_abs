...
\inputcode{Dinic}{FlowMatching/Dinic.cpp}
\inputcode{Min Cost Max Flow}{FlowMatching/MCMF.cpp}
...
\inputcode{SW Min Cut}{FlowMatching/SW.cpp} % NTUJ 1878
...
\inputcode{Min Cost Circulation}{FlowMatching/MinCostCirculation.cpp} % copy from 8BQube
% \inputcode{Weighted Blossom}{FlowMatching/WeightGeneralGraphMatching.cpp} % Library Checker "General Weighted Matching"
\inputtex{Flow Model}{FlowMatching/FlowModel.tex}

\section{Graph}
% \inputcode{Binary Lifting*}{Graph/BinaryLifting.cpp}
\inputcode{Heavy-Light Decomposition}{Graph/HeavyLightDecomp.cpp}
\inputcode{Centroid Decomposition}{Graph/CentroidDecomp.cpp}
...
\inputcode{SCC / 2SAT}{Graph/2SAT.cpp} % CF 1657F, Library Checker
...
\inputcode{Bipartite Edge Coloring}{Graph/BipartiteEdgeColoring.cpp}
\inputcode{Edge Coloring}{Graph/Vizing.cpp}
\inputcode{Maximum Clique}{Graph/MaxCliqueDyn.cpp} % Library Checker
