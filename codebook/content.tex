...
\lstinputlisting{FlowMatching/MinCostCirculation.cpp} % copy from 8BQube
...
\lstinputlisting{Graph/BipartiteEdgeColoring.cpp}
\subsection{Edge Coloring}
\lstinputlisting{Graph/Vizing.cpp}
\subsection{Maximum Clique}
\lstinputlisting{Graph/MaxCliqueDyn.cpp} % Library Checker
...
\subsection{Ext GCD}
\lstinputlisting{Math/Extgcd.cpp} % Stress Tests
\subsection{Chinese Remainder Theorem}
\lstinputlisting{Math/CRT.cpp} % ABC 193E
\subsection{PiCount}
...
\lstinputlisting{Math/DiscreteLog.cpp} % Library Checker
\subsection{Simplex}
...
\lstinputlisting{Geometry/PointInCC.cpp}
...
\lstinputlisting{Geometry/DelaunayTriangulation.cpp} % NTUJ 3667, CF acmsgrur 383
\subsection{Triangulation Vonoroi}
\lstinputlisting{Geometry/Triangulation_Vonoroi.cpp} % NTUJ 3667, CF acmsguru 383
\subsection{3D Point}
...
\lstinputlisting{Else/LineContainer.cpp}
\subsection{Min Plus Convolution}
\lstinputlisting{Else/MinPlusConvolution.cpp}
