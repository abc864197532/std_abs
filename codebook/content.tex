...
\inputcode{Suffix Array}{String/SAIS-C++20.cpp} % Library Checker, copy from ckiseki
...
\inputcode{Gauss Elimination}{Math/Gauss.cpp} % Library Checker
...
\inputtex{Calculus}{Math/Calculus.tex}
...
\inputcodenohash{Intersections}{Geometry/Intersections.cpp}
\inputcodenohash{Point Inside Check}{Geometry/PointInside.cpp} % ABC 296G
...
\inputcodenohash{Point Inside Triangle}{Geometry/PointInTriangle.cpp}
\inputcode{Heart}{Geometry/Heart.cpp}
\inputcode{Tangents}{Geometry/Tangents.cpp}
\inputcode{Convex Cut}{Geometry/PolyCut.cpp}
